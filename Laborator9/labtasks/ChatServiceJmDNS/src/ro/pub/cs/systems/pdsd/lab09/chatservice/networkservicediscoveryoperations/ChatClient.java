			...
			if (printWriter != null) {
				try {
					...
					while (!Thread.currentThread().isInterrupted()) {
						...
						if(msg != null)
						{
							Log.d(Constants.TAG, "Send: " + msg);
							printWriter.println(msg);
							printWriter.flush();
							Message newmessage = new Message(msg, Constants.MESSAGE_TYPE_SENT);
							...
							if (context != null) {
								  ...
								  if (fragment instanceof ChatConversationFragment && fragment.isVisible()) {
								    ...
								    chatConversationFragment.appendMessage(newmessage);
								  }
								}							
						}
					}
			...
			if (bufferedReader != null) {
				try {
					...
					while (!Thread.currentThread().isInterrupted()) {
						...
						if(message != null)
						{
							Log.d(Constants.TAG, "Recv: " + message);
							Message newmessage = new Message(message, Constants.MESSAGE_TYPE_RECEIVED);
							conversationHistory.add(newmessage);
