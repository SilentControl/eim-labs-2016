...
public class ServerThread extends Thread {
	...
	public HashMap<String, ServData> keep = new HashMap<String, ServData>();
	...
	public synchronized HashMap<String, ServData> getData() {
		return keep;
	}
	...
	public void run() {
		try {		
			while (!Thread.currentThread().isInterrupted()) {
				...
				CommunicationThread communicationThread = new CommunicationThread(this, socket, keep);
